        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-300 text-lg">It's {currentTime} - time for some great music</p>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-green-500/25"
              >
            ...
            <div className="flex items-center gap-6 p-4 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-green-400 text-sm font-semibold">Featured Track</span>
                </div>
                <h3 className="text-xl font-bold mb-1">{featuredTrack.title}</h3>
                <p className="text-gray-400">{featuredTrack.subtitle || featuredTrack.artist?.name}</p>
              </div>
